...
text_color  = [1, 0, 1];
font_name   = 'Consolas';
hdle_text_t                 = text(0.45 * AC_DIMENSION * 1.5, 0.55 * AC_DIMENSION * 4.5, 't=  0 sec', 'Color',text_color, 'FontSize',FontSize, 'FontName', font_name);
hdle_text_psi_deg           = text(0.45 * AC_DIMENSION * 1.5, 0.55 * AC_DIMENSION * 4.5, 0.56 * AC_DIMENSION * 1.5, '', 'Color',text_color, 'FontSize', FontSize, 'FontName', font_name);
hdle_text_th                = text(0.45 * AC_DIMENSION * 1.5, 0.55 * AC_DIMENSION * 4.5, 0.49 * AC_DIMENSION * 1.5, '', 'Color',text_color, 'FontSize', FontSize, 'FontName', font_name);
hdle_text_phi               = text(0.45 * AC_DIMENSION * 1.5, 0.55 * AC_DIMENSION * 4.5, 0.43 * AC_DIMENSION * 1.5, '', 'Color',text_color, 'FontSize', FontSize, 'FontName', font_name);
